...
class ViewController_content: UIViewController, CLLocationManagerDelegate {
    @IBOutlet weak var pwjDetail: UITextView!
//    @IBOutlet weak var bMapView: BMKMapView!
    @IBOutlet var bmapWebView: UIWebView!
...
//        mapView.setTranslatesAutoresizingMaskIntoConstraints(true)
        labelText.text = "\(data!)"
        bmapWebView.loadRequest(request)
