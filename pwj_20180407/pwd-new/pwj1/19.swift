...
class ShijiudaTableViewController: UIViewController, CLLocationManagerDelegate, UISearchBarDelegate {
    ...
    override func viewDidLoad() {
        ...
        let url = URL(string: "http://43.227.101.2/pwjstore/advlist.php")     //http://42.200.33.22/pwjstore/advlist.php
